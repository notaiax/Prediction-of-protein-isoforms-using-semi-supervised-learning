...
for model in models:
    ...
    for fold in range(num_folds):
        ...
        NUM_FEATURES = next(iter(train_loaders[1]))[0].shape[1]
        NUM_OUTPUT = next(iter(train_loaders[1]))[1].shape[1]
        ...
        for epoch in range(num_epochs):
            ...
            for inputs, targets in train_loaders[1]:
            ...
            with torch.no_grad():
                ...
                for inputs, targets in test_loaders[1]:
